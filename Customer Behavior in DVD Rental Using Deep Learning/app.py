...
with col2:
    ...
    Movie_Category_Cluster = pd.read_csv("Model/Movie_Category_Cluster.csv")
    Actor = pd.read_csv("Model/Actor.csv")
    actor_analys = pd.read_csv(("Model/actor_analys.csv"))
    ...
    st.subheader("Advisable Length")
    # Replace this placeholder with actual data retrieval logic
    st.write("Length data not implemented")
